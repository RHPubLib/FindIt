...
| Path | Purpose |
|------|---------|
| `/home/youruser/FindIT/map-app/index.html` | Page shell |
| `/home/youruser/FindIT/map-app/js/app.js` | Search, results, info panel |
| `/home/youruser/FindIT/map-app/js/map-viewer.js` | Floor tabs, zoom, pan |
| `/home/youruser/FindIT/map-app/js/map-engine.js` | Matching logic, SVG rendering, landmarks |
| `/home/youruser/FindIT/map-app/js/map-config.js` | Config loader, floor definitions |
| `/home/youruser/FindIT/map-app/css/map-app.css` | All styles including responsive |
