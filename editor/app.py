...
GODADDY_HOST = os.environ.get("GODADDY_HOST", "REDACTED-HOST-IP")
GODADDY_USER = os.environ.get("GODADDY_USER", "youruser")
GODADDY_KEY = os.environ.get("GODADDY_SSH_KEY", "/home/youruser/.ssh/your_publish_key")
GODADDY_RANGES_PATH = os.environ.get(
    "GODADDY_RANGES_PATH",
    "/home/youruser/public_html/FindIt/libraries/rhpl/ranges.json"
)
GODADDY_JS_PATH = os.environ.get(
    "GODADDY_JS_PATH",
    "/home/youruser/public_html/FindIt/libraries/rhpl/findit-rhpl.js"
)
